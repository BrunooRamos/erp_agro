...
import { useCreateMachinery, useUpdateMachinery, useGetMachinery } from "../../../../hooks";
...
export const FormMachinery = () => {
    ...
    // Form
    const { register, handleSubmit, formState: { errors }, setValue, watch, reset } = useForm<MachineryForm>();
    
    // Get machinery data when editing
    const { data: machineryData, isLoading: isLoadingMachinery } = useGetMachinery(code);
    ...
    const { mutate: createMachinery } = useCreateMachinery();
    const { mutate: updateMachinery } = useUpdateMachinery();
    ...
    useEffect(() => {
        if (selectedLabor && cusa) {
            const selectedCusaItem = cusa.find(item => item.cod_laboreo === selectedLabor);
            if (selectedCusaItem) {
    ...
    const onSubmit = handleSubmit((data) => {
        if (isEditing && code) {
            ...
            createMachinery(data, {
                ...
                onError: (error) => {
                    toast.error('Error al crear la maquinaria: ' + error);
                }
            });
        }
    });
                   ...
                   {/* Fabrication Year */}
                    <div className="mb-4">
                        ...
                        {errors.year_fabrication && (
                            <p className="text-red-500 text-sm mt-1">{errors.year_fabrication.message}</p>
                        )}
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        {errors.year_purchase && (
                            <p className="text-red-500 text-sm mt-1">{errors.year_purchase.message}</p>
                        )}
                    </div>
                    ...
                    <div className="col-span-2">
                        <h2 className="text-xl font-semibold mb-4 mt-6 text-zinc-800">Detalles Técnicos</h2>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        {errors.labor && (
                            <p className="text-red-500 text-sm mt-1">{errors.labor.message}</p>
                        )}
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        />
                        {errors.cusa_cost && (
                            <p className="text-red-500 text-sm mt-1">{errors.cusa_cost.message}</p>
                        )}
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        />
                        {errors.lts && (
                            <p className="text-red-500 text-sm mt-1">{errors.lts.message}</p>
                        )}
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        {errors.maintenance_hours && (
                            <p className="text-red-500 text-sm mt-1">{errors.maintenance_hours.message}</p>
                        )}
                    </div>

                    {/* Documentation Section */}
                    <div className="col-span-2">
                        <h2 className="text-xl font-semibold mb-4 mt-6 text-zinc-800">Documentación</h2>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        />
                        {errors.padron && (
                            <p className="text-red-500 text-sm mt-1">{errors.padron.message}</p>
                        )}
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        />
                        {errors.id_padron && (
                            <p className="text-red-500 text-sm mt-1">{errors.id_padron.message}</p>
                        )}
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        />
                        {errors.insurance && (
                            <p className="text-red-500 text-sm mt-1">{errors.insurance.message}</p>
                        )}
                    </div>
