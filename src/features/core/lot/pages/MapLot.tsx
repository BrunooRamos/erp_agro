...
export const MapLot = () => {
    ...
    const { getMapLot } = useLot();
    const { data: fields = [], isLoading } = getMapLot as { data: MapResponse[], isLoading: boolean };
    ...
    return (
        <div className="flex flex-col gap-4">
            <h1 className="text-2xl font-bold">Mapa de Lotes</h1>
            ...
            <div className="mt-4">
                <h2 className="text-xl font-semibold mb-4">Detalle de Lotes</h2>
                    ...
                    {fields.map((field) => (
                        ...
                        >
                            ...
                            <div className="text-sm text-gray-600">
                                <p className="font-bold">Campo: {field.campo_name}</p>
                                <p>ID: {field.id}</p>
